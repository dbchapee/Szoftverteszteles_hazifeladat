...
public class CartSummary {
	...
	public WebElement getCheckbox() {
		return Utils.waitForElementPresence(driver, By.id("addressesAreEquals"), 30);
	}
	...
	public WebElement getCartAddressBtn() {
		return Utils.waitToBeClickable(driver, By.name("processAddress"), 30);
	}
	public Select getDeliveryAddress() {
		return new Select( driver.findElement(By.id("id_address_delivery")));
	}
	public Select getBillingAddress() {
		return new Select( driver.findElement(By.id("id_address_invoice")));
	}
